...
?>
  <div class="container-fluid mr-bot40 mg-posts-sec-inner">
        ...
        <div class="row">
            <?php $you_missed_title = get_theme_mod('you_missed_title', esc_html__('You missed','news-bit'));
            if($you_missed_title) { ?>
            <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 text-xs">
                                <p>
                                <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'news-bit' ) ); ?>">
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Proudly powered by %s', 'news-bit' ), 'WordPress' );
								?>
								</a>
								<span class="sep"> | </span>
								<?php
								/* translators: placeholder replaced with string */
								printf( esc_html__( 'Theme: %1$s by %2$s.', 'news-bit' ), 'News Bit', '<a href="' . esc_url( __( 'https://themeansar.com/', 'news-nit' ) ) . '" rel="designer">Themeansar</a>' );
								?>
								</p>
                            </div>
