...
<?php _e( 'Skip to content', 'news-bit' ); ?></a>
    <div class="wrapper" id="custom-background-css">
        <header class="mg-headwidget">
            <!--==================== TOP BAR ====================-->

            <?php do_action('newsbit_action_header_section');  ?>
        ...
        <div class="container-fluid flex-row">
                ...
                <!-- Right nav -->
                    <div class="m-header pl-3 ml-auto my-2 my-lg-0 position-relative align-items-center">
                        ...
                        <!-- navbar-toggle -->
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','news-bit'); ?>">
...
<?php $show_popular_tags_title = newsup_get_option('show_popular_tags_title');
 ...
 do_action('newsbit_action_front_page_main_section_1'); ?>